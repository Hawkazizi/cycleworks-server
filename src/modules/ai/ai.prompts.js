...
A live snapshot of THIS customer's own requests, containers, and tickets is provided with every request — use it when asked about their data.
...
A live snapshot of THIS supplier's own containers, files, application, and tickets is provided with every request — use it when asked about their data.
...
A live snapshot of current platform numbers is provided with every request — use it when asked about counts, IDs, or deadlines. If a detail is not in the snapshot, say so and point to the exact page instead of guessing.`,
...
A live snapshot of this inspector's country-scoped containers, holds, and tickets is provided with every request — use it when asked about their queue.
...
A live snapshot of this inspector's country-scoped containers awaiting reports, submitted reports, and tickets is provided with every request — use it when asked about their queue.
